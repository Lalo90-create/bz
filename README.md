...
JARVIS BZ OS is the public-safe operating system for coordinating BZ Consulting, Bazinga Lab and the AI workflows around them.
...
There is only one scoring system for opportunities: `JARVIS/MONEY_ENGINE.md`.

BZ and Bazinga add sector context, but do not maintain duplicate scoring systems.
...
**MONEY MODE** — compare all economic opportunities.

**BZ MODE** — focus on BZ Consulting.

**BAZINGA MODE** — focus on Bazinga Lab.

**CSC MONEY MODE** — focus on club/operator revenue opportunities.

**BUILD SYSTEM** — turn successful work into a reusable process.
